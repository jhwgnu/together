...
$__Context->ci = &$__Context->column_info;
	...
	$__Context->lsttp = in_array($__Context->lsttp, array('gallery','webzine'))?$__Context->lsttp:'list';
	$__Context->us_blind = $__Context->mi->use_blind=='Y';
	$__Context->us_slide = $__Context->lsttp==='gallery'&&$__Context->mi->thumbnail_slide=='Y';
	...
	$__Context->_tmp = array('/%MID%/','/%LOGIN%/','/%URL%/','/%TITLE%/','/%NAME%/','/%SRL%/');
	...
	$__Context->mi->sub_title = $__Context->mi->sub_title ? preg_replace($__Context->_tmp,$__Context->_tmp2,$__Context->mi->sub_title) : '';
	$__Context->mi->board_desc = $__Context->mi->board_desc ? preg_replace($__Context->_tmp,$__Context->_tmp2,$__Context->mi->board_desc) : '';
	$__Context->mi->document_default_title = $__Context->mi->document_default_title ? preg_replace($__Context->_tmp,$__Context->_tmp2,$__Context->mi->document_default_title) : '';
	$__Context->mi->document_default_content = $__Context->mi->document_default_content ? preg_replace($__Context->_tmp,$__Context->_tmp2,$__Context->mi->document_default_content) : '';
	$__Context->mi->document_bottom_text = $__Context->mi->document_bottom_text ? preg_replace($__Context->_tmp,$__Context->_tmp2,$__Context->mi->document_bottom_text) : '';
 ?>
<?php if(__DEBUG__){ ?>
	<!--#Meta:modules/beluxe/tpl/js/uploader.ajax.js--><?php $__tmp=array('modules/beluxe/tpl/js/uploader.ajax.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
	...
	<?php } ?>
	<!--#Meta:modules/beluxe/skins/default/mobile/mboard.css--><?php $__tmp=array('modules/beluxe/skins/default/mobile/mboard.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
	<!--#Meta:modules/beluxe/skins/default/mobile/mboard.js--><?php $__tmp=array('modules/beluxe/skins/default/mobile/mboard.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php }else{ ?>
	<!--#Meta:modules/beluxe/tpl/js/uploader.min.js--><?php $__tmp=array('modules/beluxe/tpl/js/uploader.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
	<?php if($__Context->us_slide){ ?>
		<?php echo Context::loadJavascriptPlugin('ui') ?>
	...
	<?php } ?>
	<!--#Meta:modules/beluxe/skins/default/mobile/mboard.min.css--><?php $__tmp=array('modules/beluxe/skins/default/mobile/mboard.min.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
	<!--#Meta:modules/beluxe/skins/default/mobile/mboard.min.js--><?php $__tmp=array('modules/beluxe/skins/default/mobile/mboard.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php } ?>
