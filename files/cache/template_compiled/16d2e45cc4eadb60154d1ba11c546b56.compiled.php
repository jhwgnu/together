                    ...
                    <div class="layer extension2 xpress_xeditor_extension_layer" id="editorExtension_<?php echo $__Context->editor_sequence ?>">
                        <ul id="editor_component_<?php echo $__Context->editor_sequence ?>" class="editorComponent">
                            <?php if($__Context->component_list&&count($__Context->component_list))foreach($__Context->component_list as $__Context->component_name => $__Context->component){ ?>
                                <li><img src="/modules/editor/components/<?php echo $__Context->component_name ?>/component_icon.gif" style="width:13px !important;height:12px !important;padding-right:5px;" alt="" onError="this.onerror=null;this.src='./common/img/blank.gif';" /><a href="#" onclick="return false;" id="component_<?php echo $__Context->editor_sequence ?>_<?php echo $__Context->component_name ?>" style="vertical-align: top;"><?php echo $__Context->component->title ?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
                </li>
