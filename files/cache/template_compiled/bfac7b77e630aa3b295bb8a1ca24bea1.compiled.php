...
<div cond="$XE_VALIDATOR_MESSAGE" class="message <?php echo $__Context->XE_VALIDATOR_MESSAGE_TYPE ?>">
					...
					<ul class="_layout_list">
						...
						<li data-admin-show="#downloadLayout">
							...
							<button type="button" class="item _btnScreenshot">
								<img src="/modules/layout/tpl/img/download.png" class="_thumbnail" alt="<?php echo $__Context->lang->install_other_layouts ?>">
							</button>
						</li>
						</script>
				...
				<div class="list">
					<ul class="_list">
						...
						<li data-admin-show="#downloadSkin">
							...
							<button type="button" class="item _btnScreenshot">
								<img src="/modules/layout/tpl/img/download.png" class="_thumbnail" alt="<?php echo $__Context->lang->install_other_skins ?>">
							</button>
						</li>
						</script>
